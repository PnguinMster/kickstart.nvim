return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '<leader><C-h>', function() harpoon:list():replace_at(1) end, { desc = '[R]eplace Harpoon 1' })
    vim.keymap.set('n', '<leader><C-j>', function() harpoon:list():replace_at(2) end, { desc = '[R]eplace Harpoon 2' })
    vim.keymap.set('n', '<leader><C-k>', function() harpoon:list():replace_at(3) end, { desc = '[R]eplace Harpoon 3' })
    vim.keymap.set('n', '<leader><C-l>', function() harpoon:list():replace_at(4) end, { desc = '[R]eplace Harpoon 4' })
  end,
}
